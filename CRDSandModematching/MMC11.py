...
class MMC:
    def __init__(self):
        ...
        tk.Label(self.mainf, text="Input Mirror의 ROC, R1 :").grid(row=0, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="Input Mirror의 반사율, Reflectivity :").grid(row=1, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="Output Mirror의 ROC, R2 :").grid(row=2, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="Output Mirror의 반사율, Reflectivity :").grid(row=3, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="Cavity의 길이, L :").grid(row=4, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="PZT의 frequency :").grid(row=5, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="입사되는 레이저의 파장 :").grid(row=6, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="입사되는 레이저의 선폭 :").grid(row=7, pady=3, sticky=tk.E)
        tk.Label(self.mainf, text="모드매칭렌즈의 초점거리 :").grid(row=8, pady=3,sticky=tk.E)
        tk.Label(self.mainf, text="모드매칭렌즈 이전의 beam waist size :").grid(row=9, pady=3, sticky=tk.E)
